...
void add_chunk(mng_datap pData,
    ...
    } else {                                    /* else we make appropriate links */
...
FREE_CHUNK_HDR (free_idat) {
    ...
    if (((mng_idatp) pHeader)->iDatasize) MNG_FREEX (pData, ((mng_idatp) pHeader)->pData,
...
FREE_CHUNK_HDR (free_iccp) {
    ...
    if (((mng_iccpp) pHeader)->iNamesize) MNG_FREEX (pData, ((mng_iccpp) pHeader)->zName,
                                                     ((mng_iccpp) pHeader)->iNamesize + 1)

    if (((mng_iccpp) pHeader)->iProfilesize) MNG_FREEX (pData, ((mng_iccpp) pHeader)->pProfile,
...
FREE_CHUNK_HDR (free_text) {
    ...
    if (((mng_textp) pHeader)->iKeywordsize) MNG_FREEX (pData, ((mng_textp) pHeader)->zKeyword,
                                                        ((mng_textp) pHeader)->iKeywordsize + 1)

    if (((mng_textp) pHeader)->iTextsize) MNG_FREEX (pData, ((mng_textp) pHeader)->zText,
...
FREE_CHUNK_HDR (free_ztxt) {
    ...
    if (((mng_ztxtp) pHeader)->iKeywordsize) MNG_FREEX (pData, ((mng_ztxtp) pHeader)->zKeyword,
                                                        ((mng_ztxtp) pHeader)->iKeywordsize + 1)

    if (((mng_ztxtp) pHeader)->iTextsize) MNG_FREEX (pData, ((mng_ztxtp) pHeader)->zText,
...
FREE_CHUNK_HDR (free_itxt) {
    ...
    if (((mng_itxtp) pHeader)->iKeywordsize) MNG_FREEX (pData, ((mng_itxtp) pHeader)->zKeyword,
                                                        ((mng_itxtp) pHeader)->iKeywordsize + 1)

    if (((mng_itxtp) pHeader)->iLanguagesize) MNG_FREEX (pData, ((mng_itxtp) pHeader)->zLanguage,
                                                         ((mng_itxtp) pHeader)->iLanguagesize + 1)

    if (((mng_itxtp) pHeader)->iTranslationsize) MNG_FREEX (pData, ((mng_itxtp) pHeader)->zTranslation,
                                                            ((mng_itxtp) pHeader)->iTranslationsize + 1)

    if (((mng_itxtp) pHeader)->iTextsize) MNG_FREEX (pData, ((mng_itxtp) pHeader)->zText,
...
FREE_CHUNK_HDR (free_splt) {
    ...
    if (((mng_spltp) pHeader)->iNamesize) MNG_FREEX (pData, ((mng_spltp) pHeader)->zName,
                                                     ((mng_spltp) pHeader)->iNamesize + 1)

    if (((mng_spltp) pHeader)->iEntrycount) MNG_FREEX (pData, ((mng_spltp) pHeader)->pEntries,
...
FREE_CHUNK_HDR (free_loop) {
    ...
    if (((mng_loopp) pHeader)->iCount) MNG_FREEX (pData, ((mng_loopp) pHeader)->pSignals,
...
FREE_CHUNK_HDR (free_past) {
    ...
    if (((mng_pastp) pHeader)->iCount) MNG_FREEX (pData, ((mng_pastp) pHeader)->pSources,
...
FREE_CHUNK_HDR (free_disc) {
    ...
    if (((mng_discp) pHeader)->iCount) MNG_FREEX (pData, ((mng_discp) pHeader)->pObjectids,
...
FREE_CHUNK_HDR (free_fram) {
    ...
    if (((mng_framp) pHeader)->iNamesize) MNG_FREEX (pData, ((mng_framp) pHeader)->zName,
                                                     ((mng_framp) pHeader)->iNamesize + 1)

    if (((mng_framp) pHeader)->iCount) MNG_FREEX (pData, ((mng_framp) pHeader)->pSyncids,
...
FREE_CHUNK_HDR (free_save) {
    ...
    for (iX = 0; iX < ((mng_savep) pHeader)->iCount; iX++) {
        if (pEntry->iNamesize) MNG_FREEX (pData, pEntry->zName, pEntry->iNamesize)

        pEntry = pEntry + sizeof(mng_save_entry);
    }

    if (((mng_savep) pHeader)->iCount) MNG_FREEX (pData, ((mng_savep) pHeader)->pEntries,
...
FREE_CHUNK_HDR (free_seek) {
    ...
    if (((mng_seekp) pHeader)->iNamesize) MNG_FREEX (pData, ((mng_seekp) pHeader)->zName,
...
FREE_CHUNK_HDR (free_expi) {
    ...
    if (((mng_expip) pHeader)->iNamesize) MNG_FREEX (pData, ((mng_expip) pHeader)->zName,
...
FREE_CHUNK_HDR (free_need) {
    ...
    if (((mng_needp) pHeader)->iKeywordssize) MNG_FREEX (pData, ((mng_needp) pHeader)->zKeywords,
...
FREE_CHUNK_HDR (free_jdaa) {
    ...
    if (((mng_jdaap) pHeader)->iDatasize) MNG_FREEX (pData, ((mng_jdaap) pHeader)->pData,
...
FREE_CHUNK_HDR (free_jdat) {
    ...
    if (((mng_jdatp) pHeader)->iDatasize) MNG_FREEX (pData, ((mng_jdatp) pHeader)->pData,
...
FREE_CHUNK_HDR (free_drop) {
    ...
    if (((mng_dropp) pHeader)->iCount) MNG_FREEX (pData, ((mng_dropp) pHeader)->pChunknames,
...
FREE_CHUNK_HDR (free_dbyk) {
    ...
    if (((mng_dbykp) pHeader)->iKeywordssize) MNG_FREEX (pData, ((mng_dbykp) pHeader)->zKeywords,
...
FREE_CHUNK_HDR (free_ordr) {
    ...
    if (((mng_ordrp) pHeader)->iCount) MNG_FREEX (pData, ((mng_ordrp) pHeader)->pEntries,
...
FREE_CHUNK_HDR (free_unknown) {
    ...
    if (((mng_unknown_chunkp) pHeader)->iDatasize) MNG_FREEX (pData, ((mng_unknown_chunkp) pHeader)->pData,
