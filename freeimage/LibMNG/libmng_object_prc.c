...
mng_retcode drop_invalid_objects(mng_datap pData) {
    ...
    while (pObject)                      /* more objects to check ? */
    {
        ...
        /* invalid ? */
        if (!((mng_imagep) pObject)->bValid) {                                  /* call appropriate cleanup */
...
mng_retcode reset_object_details(mng_datap pData,
    ...
    /* buffer size changed ? */
    if (iImgdatasize != pBuf->iImgdatasize) {                                    /* drop the old one */
...
mng_retcode promote_imageobject(mng_datap pData,
    ...
    if ((pBuf->iColortype == 3) && (iColortype == 2)) {                                    /* indexed -> rgb */
        iNewsamplesize = 3;
        ...
        pBuf->bHasPLTE = MNG_FALSE;
        pBuf->bHasTRNS = MNG_FALSE;
    } else if ((pBuf->iColortype == 3) && (iColortype == 6)) {                                    /* indexed -> rgba */
        iNewsamplesize = 4;
        iNewrowsize = iW * iNewsamplesize;
        iNewbufsize = iH * iNewrowsize;
...
mng_retcode magnify_imageobject(mng_datap pData,
    ...
    {                                    /* concrete buffer ? */
        if ((pBuf->bConcrete) && (pImage->iId)) MNG_ERROR (pData, MNG_INVALIDCOLORTYPE)
    ...
    switch (pBuf->iColortype)            /* determine magnification routines */
    {
        ...
        case 8 : {
            if (pBuf->iBitdepth <= 8) {
                switch (pImage->iMAGN_MethodX) {
                    case 1  : {
                        fMagnifyX = magnify_g8_x1;
                        break;
                    }
                    case 2  : {
                        fMagnifyX = magnify_g8_x2;
                        break;
                    }
                    case 3  : {
                        fMagnifyX = magnify_g8_x3;
                        break;
                    }
                    case 4  : {
                        fMagnifyX = magnify_g8_x2;
                ...
                switch (pImage->iMAGN_MethodY) {
                    case 1  : {
                        fMagnifyY = magnify_g8_y1;
                        break;
                    }
                    case 2  : {
                        fMagnifyY = magnify_g8_y2;
                        break;
                    }
                    case 3  : {
                        fMagnifyY = magnify_g8_y3;
                        break;
                    }
                    case 4  : {
                        fMagnifyY = magnify_g8_y2;
        ...
        case 10 : {
            if (pBuf->iBitdepth <= 8) {
                switch (pImage->iMAGN_MethodX) {
                    case 1  : {
                        fMagnifyX = magnify_rgb8_x1;
                        break;
                    }
                    case 2  : {
                        fMagnifyX = magnify_rgb8_x2;
                        break;
                    }
                    case 3  : {
                        fMagnifyX = magnify_rgb8_x3;
                        break;
                    }
                    case 4  : {
                        fMagnifyX = magnify_rgb8_x2;
                ...
                switch (pImage->iMAGN_MethodY) {
                    case 1  : {
                        fMagnifyY = magnify_rgb8_y1;
                        break;
                    }
                    case 2  : {
                        fMagnifyY = magnify_rgb8_y2;
                        break;
                    }
                    case 3  : {
                        fMagnifyY = magnify_rgb8_y3;
                        break;
                    }
                    case 4  : {
                        fMagnifyY = magnify_rgb8_y2;
        ...
        case 12 : {
            if (pBuf->iBitdepth <= 8) {
                switch (pImage->iMAGN_MethodX) {
                    case 1  : {
                        fMagnifyX = magnify_ga8_x1;
                        break;
                    }
                    case 2  : {
                        fMagnifyX = magnify_ga8_x2;
                        break;
                    }
                    case 3  : {
                        fMagnifyX = magnify_ga8_x3;
                        break;
                    }
                    case 4  : {
                        fMagnifyX = magnify_ga8_x4;
                        break;
                    }
                    case 5  : {
                        fMagnifyX = magnify_ga8_x5;
                        break;
                    }
                }
                ...
                switch (pImage->iMAGN_MethodY) {
                    case 1  : {
                        fMagnifyY = magnify_ga8_y1;
                        break;
                    }
                    case 2  : {
                        fMagnifyY = magnify_ga8_y2;
                        break;
                    }
                    case 3  : {
                        fMagnifyY = magnify_ga8_y3;
                        break;
                    }
                    case 4  : {
                        fMagnifyY = magnify_ga8_y4;
                        break;
                    }
                    case 5  : {
                        fMagnifyY = magnify_ga8_y5;
                        break;
                    }
                }
            } else {
        ...
        case 14 : {
            if (pBuf->iBitdepth <= 8) {
                switch (pImage->iMAGN_MethodX) {
                    case 1  : {
                        fMagnifyX = magnify_rgba8_x1;
                        break;
                    }
                    case 2  : {
                        fMagnifyX = magnify_rgba8_x2;
                        break;
                    }
                    case 3  : {
                        fMagnifyX = magnify_rgba8_x3;
                        break;
                    }
                    case 4  : {
                        fMagnifyX = magnify_rgba8_x4;
                        break;
                    }
                    case 5  : {
                        fMagnifyX = magnify_rgba8_x5;
                        break;
                    }
                }
                ...
                switch (pImage->iMAGN_MethodY) {
                    case 1  : {
                        fMagnifyY = magnify_rgba8_y1;
                        break;
                    }
                    case 2  : {
                        fMagnifyY = magnify_rgba8_y2;
                        break;
                    }
                    case 3  : {
                        fMagnifyY = magnify_rgba8_y3;
                        break;
                    }
                    case 4  : {
                        fMagnifyY = magnify_rgba8_y4;
                        break;
                    }
                    case 5  : {
                        fMagnifyY = magnify_rgba8_y5;
                        break;
                    }
                }
            } else {
...
mng_retcode process_ani_image(mng_datap pData,
    ...
    } else if (pData->pCurrentobj)              /* active object ? */
    {
...
mng_retcode free_ani_iccp(mng_datap pData,
    ...
    if (pICCP->iProfilesize) MNG_FREEX (pData, pICCP->pProfile, pICCP->iProfilesize)
...
mng_retcode process_ani_iccp(mng_datap pData,
    ...
    {                                    /* clear global iCCP */
        ...
        if (pData->iGlobalProfilesize) MNG_FREEX (pData, pData->pGlobalProfile, pData->iGlobalProfilesize)

        pData->iGlobalProfilesize = 0;
        pData->pGlobalProfile = MNG_NULL;
    } else {                                    /* set global iCCP */
