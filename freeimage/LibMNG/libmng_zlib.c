...
/*        if ((!iRslt) && (pData->iFilterofs < pData->iPixelofs  ) &&
    ...
    /* on error bail out */
    if ((iZrslt != Z_OK) && (iZrslt != Z_STREAM_END)) MNG_ERRORZ (pData, (mng_uint32) iZrslt)
