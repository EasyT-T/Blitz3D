...
struct TerrainRep::Tri
{
    ...
    Tri(const int id, const int clip, const int v0, const int v1, const int v2, Tri* e0 = nullptr, Tri* e1 = nullptr,
        Tri* e2 = nullptr) :
        id(id), clip(clip),
        v0(v0), v1(v1), v2(v2),
...
TerrainRep::Error TerrainRep::calcErr(const int id, const int x, const int z, const Vert& v0, const Vert& v1,
                                      const Vert& v2) const
{
    Error et;
...
bool TerrainRep::collide(const Line& line, const float radius, Collision* curr_coll, const Transform& tform,
                         const int id,
